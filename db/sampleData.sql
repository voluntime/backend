...
insert into post(created, begins, ends, organizer, title, body, event_location, event_type, goal) values (now(), now(), now() + INTERVAL '30 minutes', 'trey_time', 'Help Adam Graduate', 'Please please please', 'Newberg, OR', 'Service', 1);
